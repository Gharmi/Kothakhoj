 ...
 */
public class ViewOtherRooms extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_renter_other_rooms, container, false);
        recyclerView = mView.findViewById(R.id.roomRecycler);
        progressBar = mView.findViewById(R.id.progressViewRooms);
        rooms = new ArrayList<>();
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        if(task.isSuccessful()) {
                            if (task.getResult().getDocuments().size() == 0) {
                                mView.findViewById(R.id.seekerSavedDefault).setVisibility(View.VISIBLE);
                            } else{
                                mView.findViewById(R.id.seekerSavedDefault).setVisibility(View.GONE);
